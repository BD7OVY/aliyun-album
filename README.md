...
面向培训场景：摄影师通过**百度网盘收集链接**上传照片 → 你回家双击 `publish.bat` → 照片自动发布到 GitHub Pages 在线相册 → 分享链接给所有人查看。

**不需要带电脑去现场**，只需要把百度网盘收集链接分享给摄影师即可。
...
1. 打开百度网盘 → 首页 → **「收集文件」**（或搜索"收集文件"功能）
2. 创建一个收集链接，设置收集到指定文件夹
3. 把收集链接分享给摄影师 —— 他们**免登录**、手机电脑都能传
